...
public class SwaggerConfig {
	...
	public Docket apiDoc() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("br.com.devdojo.endpoint")).paths(regex("/v1.*")).build()
	...
	private ApiInfo metaData() {
		return new ApiInfoBuilder().title("Spring Boot Essentials By DevDojo")
				.description("The best spring course out there").version("1.0")
